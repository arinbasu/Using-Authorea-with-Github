...
Once you start working with this strategy you realise hat that it it is better tow to work with Google chrome rather than with other browsers; I also found out hat that it is better to in case of dificulties, cleaning the cache or history is a way to overcome these issues. So reluctantly, I will have to use Google Crhom Chrome 
